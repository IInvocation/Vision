// COPIED FROM https://github.com/paulcbetts/mvvmlight/blob/master/GalaSoft.MvvmLight/GalaSoft.MvvmLight.Extras%20(NET35)/Ioc/SimpleIoc.cs
// Readjusted class for NetStandard 1.6
// 13.07.2017 - Achim Schnell
	...
	public class SimpleIoc : IServiceLocator
	{
			...
			where TClass : class
		{
			lock (_syncLock)
			{
				...
				if (!_instancesRegistry.ContainsKey(classType)) return;
