...
{
	/// <summary>	Interface for validate credentials result. </summary>
	public interface IValidateCredentialsResult
	{
		...
		IEnumerable<ValidateCredentialsFaultReason> Faults { get; }
	}
}