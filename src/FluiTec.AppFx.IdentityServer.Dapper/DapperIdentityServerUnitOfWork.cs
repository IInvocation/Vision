...
namespace FluiTec.AppFx.IdentityServer.Dapper
{
	...
	public class DapperIdentityServerUnitOfWork : DapperUnitOfWork, IIdentityServerUnitOfWork
	{
		...
		/// <summary>	The client scope repository. </summary>
		public IClientScopeRepository ClientScopeRepository => _clientScopeRepository ??
		                                                       (_clientScopeRepository =
			                                                       GetRepository<IClientScopeRepository>());

		/// <summary>	The API resource repository. </summary>
		public IApiResourceRepository ApiResourceRepository => _apiResourceRepository ??
		                                                       (_apiResourceRepository =
			                                                       GetRepository<IApiResourceRepository>());

		/// <summary>	The scope repository. </summary>
		public IScopeRepository ScopeRepository => _scopeRepository ?? (_scopeRepository = GetRepository<IScopeRepository>());

		/// <summary>	The API resource scope repository. </summary>
		public IApiResourceScopeRepository ApiResourceScopeRepository => _apiResourceScopeRepository ??
		                                                                 (_apiResourceScopeRepository =
			                                                                 GetRepository<IApiResourceScopeRepository>());

		/// <summary>	The API resource claim repository. </summary>
		public IApiResourceClaimRepository ApiResourceClaimRepository => _apiResourceClaimRepository ??
		                                                                 (_apiResourceClaimRepository =
			                                                                 GetRepository<IApiResourceClaimRepository>());

		/// <summary>	The identity resource repository. </summary>
		public IIdentityResourceRepository IdentityResourceRepository => _identityResourceRepository ??
		                                                                 (_identityResourceRepository =
			                                                                 GetRepository<IIdentityResourceRepository>());

		/// <summary>	The identity resource claim repository. </summary>
		public IIdentityResourceClaimRepository IdentityResourceClaimRepository => _identityResourceClaimRepository ??
		                                                                           (_identityResourceClaimRepository =
			                                                                           GetRepository<
				                                                                           IIdentityResourceClaimRepository>());

		/// <summary>	The identity resource scope repository. </summary>
		public IIdentityResourceScopeRepository IdentityResourceScopeRepository => _identityResourceScopeRepository ??
